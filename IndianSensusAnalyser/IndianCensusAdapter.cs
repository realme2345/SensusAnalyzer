using IndianSensusAnalyser.DataDAO;
using IndianSensusAnalyser.DTO;
using System;
...
namespace IndianSensusAnalyser
{
            ...
            try
            {
                ...
                foreach (string data in censusData.Skip(1))
                {
                    ...
                    if (csvFilePath.Contains("IndianPopulation.csv"))
                        censusState.Add(coloumn[0], new CensusDTO(new PapulationDataDAO(coloumn[0], coloumn[1], coloumn[2], coloumn[3])));
                }
                return censusState;
            }
